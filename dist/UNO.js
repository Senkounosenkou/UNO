(function() {
	...
	function renderGameBoard(spaceEl, { currentCard, myHand, myPlayerIndex, myPlayerName, deckCount, turnPlayerName, currentTurnIndex, currentDirection, currentPenalty, winnerName }) {
		...
		if (myPlayerIndex !== -1) {
			...
			else if (myPlayerIndex === currentTurnIndex) if (currentPenalty > 0) btnHTML = `
